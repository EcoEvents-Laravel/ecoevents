...
<div class="container my-5">
    <div class="card mx-auto shadow" style="max-width: 28rem;">
        <div class="card-body text-center">
            <img src="{{ $badge->image_url }}" alt="{{ $badge->name }}" class="rounded-circle border border-success mb-4" style="width: 120px; height: 120px; object-fit: contain; background: #e9fbe5;">
