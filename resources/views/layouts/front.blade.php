            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <a href="{{ route('events.frontevent') }}" class="text-gray-700 hover:text-green-600 font-medium transition-colors duration-300 relative group">
                            Événements
                            <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-green-600 group-hover:w-full transition-all duration-300"></span>
                        </a>
                        <a href="#" class="text-gray-700 hover:text-green-600 font-medium transition-colors duration-300 relative group {{ request()->routeIs('blogs.*') ? 'text-green-600' : '' }}">
                            Blog
                    ...
                    <div class="hidden md:flex items-center gap-4">
                        ...
                        @else
                            <a href="#" class="px-4 py-2 text-gray-700 hover:text-green-600 font-medium transition-colors duration-300">
                                Connexion
                            </a>
                            <a href="#" class="px-6 py-2 bg-gradient-to-r from-green-500 to-blue-500 text-white font-semibold rounded-lg hover:from-green-600 hover:to-blue-600 transition-all duration-300 shadow-md hover:shadow-lg">
                                S'inscrire
                            </a>
                        @endauth
                    </div>
        ...
        <div class="mobile-menu fixed top-0 right-0 h-full w-80 bg-white shadow-2xl z-50" id="mobileMenu">
            <div class="p-6">
                ...
                <nav class="space-y-4">
                    ...
                    @else
                        <hr class="my-6">
                        <a href="#" class="block px-4 py-3 text-center border-2 border-green-500 text-green-600 rounded-lg font-semibold hover:bg-green-50 transition-all duration-300">
                            Connexion
                        </a>
                        <a href="#" class="block px-4 py-3 text-center bg-gradient-to-r from-green-500 to-blue-500 text-white rounded-lg font-semibold hover:from-green-600 hover:to-blue-600 transition-all duration-300">
                            S'inscrire
                        </a>
                    @endauth
                </nav>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li><a href="{{ route('events.frontevent') }}" class="text-gray-400 hover:text-green-400 transition-colors duration-300">Événements</a></li>
