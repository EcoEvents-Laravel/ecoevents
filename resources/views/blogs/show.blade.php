        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <main class="lg:col-span-8">
                <div class="bg-white rounded-3xl shadow-xl p-8 md:p-12">
                    ...
                    {{-- Actions Admin --}}
                    @auth
                    <div class="flex gap-3 mb-8 pb-6 border-b border-gray-200">
                        <a href="{{ route('blogs.edit', $blog) }}" class="flex items-center gap-2 px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all duration-300 shadow-md hover:shadow-lg">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <form action="{{ route('blogs.destroy', $blog) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet article ?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="flex items-center gap-2 px-6 py-3 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-all duration-300 shadow-md hover:shadow-lg">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-12 bg-white rounded-3xl shadow-xl p-8 md:p-12">
                    ...
                    <div class="mb-12">
                        ...
                        <div class="flex justify-end mt-4">
                            <button class="px-8 py-3 bg-green-500 text-white font-semibold rounded-xl hover:bg-green-600 transition-all duration-300 shadow-md hover:shadow-lg">
